  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow">
        ...
        {/* PARTE 1: A INVESTIGAÇÃO (Conteúdo Original) */}
        <section className="py-20 bg-background border-b border-primary/5">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <h1 className="text-4xl sm:text-6xl font-black text-foreground mb-10 leading-tight">
              Desenvolvimento de uma <br/>
              <span className="text-primary">Plataforma Digital de Segurança</span>
            </h1>
            
            <div className="prose prose-lg max-w-none text-foreground/85 space-y-8">
              <section className="bg-muted/30 p-8 rounded-3xl border border-primary/10">
                <h2 className="text-2xl font-bold text-primary mb-4 flex items-center gap-2">
                  <Info className="w-6 h-6" /> Contexto e Propósito
                </h2>
                <p className="text-lg leading-relaxed">
                  Todos os anos, milhares de cidadãos em Angola são direta ou indiretamente afetados pela criminalidade urbana. O impacto desses atos vai muito além das perdas materiais — fere a confiança nas instituições, gera medo e mina o bem-estar das comunidades.
                </p>
                <p className="text-lg leading-relaxed mt-4">
                  Dessa visão nasceu o projeto "Desenvolvimento de uma Plataforma Digital com base o Inquérito de Vitimização Criminal e Percepção de Segurança no Município da Samba" uma iniciativa que marca o encontro entre as Ciências Criminais e a Engenharia Informática.
                </p>
              </section>

              <div className="grid gap-6 md:grid-cols-2 mt-12">
                <Card className="border-primary/10 shadow-md">
                  <CardHeader><CardTitle className="text-primary flex items-center gap-2"><Target className="w-5 h-5"/> Monitoramento</CardTitle></CardHeader>
                  <CardContent>Monitorar padrões de criminalidade e avaliar a percepção de segurança de forma sistemática no Município da Samba.</CardContent>
                </Card>
                <Card className="border-primary/10 shadow-md">
                  <CardHeader><CardTitle className="text-primary flex items-center gap-2"><Lightbulb className="w-5 h-5"/> Inovação</CardTitle></CardHeader>
                  <CardContent>Incorporar inteligência artificial para oferecer tendências e previsões acessíveis a toda a comunidade.</CardContent>
                </Card>
              </div>
            </div>
          </div>
