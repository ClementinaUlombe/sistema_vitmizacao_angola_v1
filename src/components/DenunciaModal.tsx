...
const DenunciaModal: React.FC<DenunciaModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (onSuccess) {
        onSuccess("Relato Enviado com Sucesso!", "A sua denúncia foi recebida e será tratada com a máxima confidencialidade pela Polícia.");
      }
    } catch (error) {
